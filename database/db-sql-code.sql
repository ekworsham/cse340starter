...
ALTER TYPE public.account_type OWNER TO cse340databasec;
...
ADD CONSTRAINT fk_cassification FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
-- Table structure fro table 'account'
